        ...
        <header className='relative'>
          ...
          <div>
            ...
            >
              {project.title}
              {isLocked ? (
                <LockIcon className='shrink-0 group-focus:animate-wiggle group-active:animate-none text-[#DBDBDB] dark:text-[#3C3C3C] group-focus:text-red-500 dark:group-focus:text-red-400 transition-colors duration-75' />
              ) : (
