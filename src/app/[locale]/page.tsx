        ...
        <div className='flex gap-5 items-center'>
          ...
          >
            <svg
              ...
              fill='none'
              viewBox='0 0 20 20'
              className='absolute inset-0 transition-all duration-300 group-hover:translate-y-5 opacity-100 group-hover:opacity-0 ease-out'
              aria-hidden='true'
            >
              <path
                fill='currentColor'
            ...
            <svg
              ...
              height='20'
              viewBox='0 0 24 24'
              className='absolute inset-0 transition-all duration-300 -translate-y-5 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 ease-out'
              aria-hidden='true'
            >
