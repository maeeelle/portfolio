    ...
    <div className='min-h-dvh flex flex-col relative overflow-hidden'>
      <header className='flex justify-between items-center px-20 py-5 font-normal text-[#282828] text-base'>
        ...
        <div className='flex gap-5 items-center'>
          ...
          <button className='w-5 h-5 relative group hover:opacity-80 transition-opacity'>
            <svg
              ...
              fill='none'
              viewBox='0 0 20 20'
              className='absolute inset-0 transition-all duration-300 group-hover:translate-y-5 group-hover:opacity-0'
            >
              <path
                fill='#000'
