...
export default async function Home({ params }: HomeProps) {
  ...
  return (
    <div className='min-h-dvh flex flex-col relative overflow-hidden'>
      <header className='flex flex-wrap justify-between items-center px-8 sm:px-20 pb-5 pt-5 font-normal text-[#282828] text-base'>
        ...
        <div className='flex gap-5 items-center'>
          ...
          <button
            ...
            className='w-5 h-5 relative group overflow-hidden'
          >
            <svg
              ...
              fill='none'
              viewBox='0 0 20 20'
              className='absolute inset-0 transition-all duration-300 -translate-y-5 opacity-0 group-hover:translate-y-0 group-hover:opacity-100'
              aria-hidden='true'
            >
              <path
                fill='currentColor'
            ...
            <svg
              ...
              height='20'
              viewBox='0 0 24 24'
              className='absolute inset-0 transition-all duration-300 group-hover:translate-y-5 opacity-100 group-hover:opacity-0'
              aria-hidden='true'
            >
      ...
      <main className='relative flex flex-col gap-y-20 px-8 sm:px-20 py-10 max-w-screen-2xl mx-auto flex-1'>
